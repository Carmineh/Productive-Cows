...
public class CowCageMenu extends AbstractContainerMenu {
    ...
    public CowCageMenu(int windowId, Inventory inv, BlockEntity be, ContainerData data) {
        super(ProductiveCows.COW_CAGE_MENU.get(), windowId);
        ...
        if (be instanceof CowCageBlockEntity cage) {
            this.addSlot(new SlotItemHandler(cage.getInventory(), 0, 129, 34) {
                ...
                public boolean mayPlace(ItemStack stack) {
                    return stack.is(ProductiveCows.CAPTURED_COW.get()) || stack.is(ProductiveCows.MATERIAL_COW_SPAWN_EGG.get());
                }
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (index < 3) {
                ...
                if (itemstack1.is(ProductiveCows.CAPTURED_COW.get()) || itemstack1.is(ProductiveCows.MATERIAL_COW_SPAWN_EGG.get())) {
