package com.productivecows.fluid;
...
public class ModFluids {
    ...
    public static final DeferredRegister<FluidType> FLUID_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.FLUID_TYPES, ProductiveCows.MODID);
    public static final DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(BuiltInRegistries.FLUID, ProductiveCows.MODID);
    ...
    public static final ResourceLocation MOLTEN_STILL = ResourceLocation.fromNamespaceAndPath(ProductiveCows.MODID, "block/molten_still");
    public static final ResourceLocation MOLTEN_FLOWING = ResourceLocation.fromNamespaceAndPath(ProductiveCows.MODID, "block/molten_flow");
        ...
        public RegisteredFluid(String name, int color, boolean isMolten) {
            ...
            this.type = FLUID_TYPES.register(name, () -> new TintedFluidType(
                    FluidType.Properties.create()
                            ...
                            .descriptionId("fluid.productivecows." + name),
            ...
            this.block = ProductiveCows.BLOCKS.register(name, () -> new LiquidBlock(
                    this.source.get(),
            ...
            this.bucket = ProductiveCows.ITEMS.register(name + "_bucket", () -> new BucketItem(
                    this.source.get(),
                    new Item.Properties()
