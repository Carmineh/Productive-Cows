...
import com.materialcows.data.MaterialCowDataLoader;
import com.materialcows.network.SyncCowDefinitionsPayload;
...
@EventBusSubscriber(modid = "materialcows")
public class CommonGameEvents {
    ...
    public static void onEntityInteract(net.neoforged.neoforge.event.entity.player.PlayerInteractEvent.EntityInteract event) {
        ...
        if (target instanceof net.minecraft.world.entity.animal.Cow vanillaCow && !(vanillaCow instanceof com.materialcows.entity.MaterialCowEntity)) {
            ...
            if (targetDef != null) {
                ...
                if (!level.isClientSide() && level instanceof net.minecraft.server.level.ServerLevel serverLevel) {
                    com.materialcows.entity.MaterialCowEntity materialCow = com.materialcows.Materialcows.MATERIAL_COW.get().create(serverLevel);
                    if (materialCow != null) {
                        ...
                        materialCow.setCowDefinitionId(ResourceLocation.fromNamespaceAndPath(com.materialcows.Materialcows.MODID, targetDef));
