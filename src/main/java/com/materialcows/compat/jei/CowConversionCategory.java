...
public class CowConversionCategory implements IRecipeCategory<CowConversionRecipe> {
    ...
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Materialcows.MODID, "conversion");
    public static final RecipeType<CowConversionRecipe> CONVERSION_TYPE = RecipeType.create(Materialcows.MODID, "conversion", CowConversionRecipe.class);
